...
# compile contract
docker run -v $PWD:/sources ethereum/solc:$COMPILER_VERSION --ir-optimized --optimize --optimize-runs=100 --bin /sources/contracts/${OUTPUT_CONTRACT}.sol --include-path /sources/node_modules/ --base-path /sources -o /sources/${OUTPUT_CONTRACT}.bin --overwrite
